...
We willen echter deze twee inputs met elkaar gesynchroniseerd houden. Wanneer we de Celsius input bijwerken, moet de Fahrenheit input de geconverteerde temperatuur weergeven en vice versa.
